...
- **الملخص التقني:**
  - `HTML5`، `CSS3` النمطي، `Vanilla JS` (ES modules)، `PHP` آمن وقابل للصيانة، `i18n` مع `JSON`، سهولة الوصول (Accessibility)، و`SVG` القابل للتوسع.
- **التوثيق والإرشادات:**
  ...
  - [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) — السلوك المتوقع والإبلاغ عن التصرفات غير الملائمة
