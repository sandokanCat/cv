...
- `HTML5`, modular `CSS3`, `Vanilla JS` (ES modules), secure & maintainable `PHP`, `i18n` with `JSON`, accessibility, scalable `SVG`

### Documentation & Guidelines

For agents, IDEs, or technical reviewers:
...
أعمل حالياً على الإصدار 2.0 من سيرتي الذاتية على الويب، والتي ستكون الصفحة الرئيسية لمحفظتي. هدفي هو التميّز عن ملفات الـPDF البسيطة المعتادة والتعريف بنفسي في مجتمع تكنولوجيا المعلومات من خلال مشاريعي الشخصية؛ حيث أضع كل موهبتي ومعارفي وجهدي لأبرز بشكل مميز. أقدّر ملاحظاتك!
