...
<div id="modal-container" role="dialog" aria-hidden="true" tabindex="-1">
    <div id="modal-content">
        <div id="modal-iframe-wrapper">
            <iframe data-i18n-attr="aria-label:modalIframe" id="modal-iframe" src="about:blank" sandbox="allow-scripts allow-forms allow-same-origin allow-popups" aria-label="<?= $L('modalIframe'); ?>"></iframe>
        </div>
