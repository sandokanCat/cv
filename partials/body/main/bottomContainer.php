...
<div id="bottom-container">
    ...
    <section>
        <div class="others">
            ...
            <a class="other-links icons-snippet active" data-i18n-attr="aria-label:downloadCV"
                ...
                <svg class="icons-color-2" aria-hidden="true" width="30" height="30"
    ...
    <section>
        <div class="others">
            ...
            <aside class="other-links js-disabled"> <!-- JS ENABLED -->
                <ul id="burger-links" data-i18n-attr="aria-label:burger" aria-label="<?= $L('burger'); ?>">
                    <li>
                        <button class="icons-snippet active" id="burger-btn"
                            aria-label="<?= $L('burgerBtn.aria-label.open'); ?>" aria-expanded="false"
                            aria-pressed="false" type="button" aria-controls="burger-links">
                            <span id="burger-icon">
                    ...
                    <li>
                        <a id="github-icon" class="icons-snippet"
                            href="<?= htmlspecialchars($path['social']['github'], ENT_QUOTES | ENT_HTML5); ?>"
                    ...
                    <li>
                        <a id="vercel-icon" class="icons-snippet"
                            href="<?= htmlspecialchars($path['social']['vercel'], ENT_QUOTES | ENT_HTML5); ?>"
                            target="_blank" rel="noopener noreferrer" aria-label="Vercel">
                            <svg class="icons-color-2" aria-hidden="true" width="30" height="30"
                                preserveAspectRatio="xMinYMin meet">
                    ...
                    <ul aria-label="Repository menu">
                        <li>
                            <a href="<?= htmlspecialchars($path['social']['github'], ENT_QUOTES | ENT_HTML5); ?>"
                                target="_blank" rel="noopener noreferrer" aria-label="Github">
                                <svg class="icons-color-2 icons-snippet active" aria-hidden="true" width="28"
                        ...
                        <li>
                            <a href="<?= htmlspecialchars($path['social']['vercel'], ENT_QUOTES | ENT_HTML5); ?>"
                                target="_blank" rel="noopener noreferrer" aria-label="Vercel">
                                <svg class="icons-color-2 icons-snippet active" aria-hidden="true" width="30"
                                    height="30" preserveAspectRatio="xMinYMin meet">
                                    <use href="img/sprite.svg#vercel" xlink:href="img/sprite.svg#vercel"></use>
                                </svg>
                            </a>
                        </li>
        ...
        <div id="portfolio">
            ...
            <a href="https://<?= htmlspecialchars($brand['user'], ENT_QUOTES | ENT_HTML5); ?>.github.io/estopa/"
                target="_blank" data-status>
                <img data-i18n-attr="alt:estopa" src="img/portfolio/estopa.png" decoding="async" loading="lazy"
                    alt="<?= $A('estopa'); ?>">
            </a>
        </div>
    </section>
